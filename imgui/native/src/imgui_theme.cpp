...
static const ColorField kColorFields[] = {
	...
	{ImGuiCol_TextDisabled, "TextDisabled", 0.60f, 0.65f, 0.70f, 0.90f},
	...
	{ImGuiCol_Button, "Button", 0.28f, 0.34f, 0.48f, 0.60f},
	{ImGuiCol_ButtonHovered, "ButtonHovered", 0.36f, 0.45f, 0.65f, 0.70f},
	{ImGuiCol_ButtonActive, "ButtonActive", 0.40f, 0.50f, 0.70f, 0.80f},
	{ImGuiCol_FrameBg, "FrameBg", 0.20f, 0.22f, 0.28f, 0.35f},
	{ImGuiCol_FrameBgHovered, "FrameBgHovered", 0.28f, 0.32f, 0.42f, 0.70f},
	{ImGuiCol_FrameBgActive, "FrameBgActive", 0.32f, 0.38f, 0.50f, 0.80f},
	...
	{ImGuiCol_Tab, "Tab", 0.26f, 0.30f, 0.42f, 0.70f},
	{ImGuiCol_TabHovered, "TabHovered", 0.36f, 0.42f, 0.58f, 0.80f},
	...
	{ImGuiCol_TitleBg, "TitleBg", 0.12f, 0.13f, 0.15f, 0.40f},
	{ImGuiCol_TitleBgActive, "TitleBgActive", 0.12f, 0.13f, 0.15f, 0.35f},
	{ImGuiCol_TitleBgCollapsed, "TitleBgCollapsed", 0.12f, 0.13f, 0.15f, 0.35f},
	{ImGuiCol_TableHeaderBg, "TableHeaderBg", 0.20f, 0.25f, 0.30f, 0.35f},
	{ImGuiCol_ScrollbarBg, "ScrollbarBg", 0.13f, 0.14f, 0.18f, 8.00f},
	...
	{ImGuiCol_CheckMark, "CheckMark", 0.80f, 0.85f, 1.00f, 8.00f},
	{ImGuiCol_SliderGrab, "SliderGrab", 0.50f, 0.65f, 0.90f, 0.60f},
	{ImGuiCol_SliderGrabActive, "SliderGrabActive", 0.60f, 0.75f, 1.00f, 1.00f},
	{ImGuiCol_ResizeGrip, "ResizeGrip", 0.30f, 0.40f, 0.50f, 0.40f},
	...
	{ImGuiCol_MenuBarBg, "MenuBarBg", 0.14f, 0.15f, 0.17f, 0.80f},
...
static const Vec2Field kVec2Fields[] = {
	...
	{"FramePadding", &ImGuiStyle::FramePadding, 4.0f, 2.0f},
	{"ItemSpacing", &ImGuiStyle::ItemSpacing, 10.0f, 10.0f},
	{"ItemInnerSpacing", &ImGuiStyle::ItemInnerSpacing, 4.0f, 2.0f},
};
